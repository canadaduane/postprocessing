"use strict";
/**
 * postprocessing v6.28.1 build Sun Jul 03 2022
...
var POSTPROCESSING = (() => {
    ...
    constructor() {
      super({
        ...
        uniforms: {
          ...
          kernel: new import_three11.Uniform(new Float32Array([
            -1,
            1,
            0.125,
            1,
    ...
    constructor({ kernelSize = 35 } = {}) {
      super({
        ...
        uniforms: {
          ...
          scale: new import_three14.Uniform(new import_three14.Vector2(1, 1))
        },
    ...
    constructor() {
      super({
        ...
        uniforms: {
          ...
          kernel: new import_three21.Uniform(new Float32Array([
            -1,
            1,
            0.0625,
            0,
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three22.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var Resolution = class extends import_three26.EventDispatcher {
    constructor(resizable, width = AUTO_SIZE, height = AUTO_SIZE, scale = 1) {
      ...
      this.base = new import_three26.Vector2(1, 1);
      this.preferred = new import_three26.Vector2(width, height);
...
`;
  ...
  var Effect = class extends import_three42.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three42.Scene || property === this.renderer) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      this.breakPoint = new import_three52.Vector2(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
  ...
  var SepiaEffect = class extends Effect {
    constructor({ blendFunction, intensity = 1 } = {}) {
      super("SepiaEffect", sepia_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["intensity", new import_three66.Uniform(intensity)]
        ])
      });
    }
    get intensity() {
